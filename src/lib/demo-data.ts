...
const SEEDS: GigSeed[] = [
  ...
  },
  {
    ...
    description:
      "I give 1-1 Mock interview session and on spot resume critique.\n\nReviews will be shared as a Drive folder. Authenticity matters more than speed.",
    gig_type: 'one_time',
    reward: 250,
    hours: 5,
    deadlineDays: 15,
  ...
  },
  {
    ...
    hirer: '05',
    title: 'Hostel Survey & Data Collection',
    description:
  ...
  },
  {
    ...
    description:
      "Conduct in-person surveys and collect questionnaire responses from students across hostels.",
    gig_type: 'one_time',
    reward: 350,
    hours: 48,
    deadlineDays: 20,
    place: ['BHU, Varanasi', 25.32, 82.995],
  ...
  },
  {
    ...
    hirer: '07',
    title: 'Handwritten Lab Data Extraction',
    description:
      "Need someone to accurately extract and digitize data from handwritten laboratory journals.",
    gig_type: 'one_time',
    reward: 500,
    hours: 18,
    deadlineDays: 4,
    place: ['IIT BHU Main Campus', 25.2677, 82.9913],
    skills: ['data-entry', 'research', 'english'],
    postedHoursAgo: 11,
    views: 415,
    applications: 27,
  },
  ...
  },
  {
    ...
    hirer: '07',
    title: 'Project Deployment & Hosting Setup',
    description:
      "Deploy the project to a suitable hosting platform and configure the production environment.\n\nSet up domains, environment variables, and basic deployment settings for smooth operation.",
    gig_type: 'one_time',
    reward: 1000,
    hours: 12,
    deadlineDays: 7,
  ...
  },
  {
    ...
    description:
      "Design a clean, modern, and engaging portfolio tailored to the individual’s skills and work.\n\nOrganize content and visuals to create a professional and easy-to-navigate experience.",
    gig_type: 'one_time',
    reward: 1500,
    hours: 48,
    deadlineDays: 10,
    place: ['IIT BHU Camopus', 25.2677, 82.9913],
    skills: ['Design and Media', 'Writing & Content'],
    postedHoursAgo: 40,
    views: 88,
    applications: 5,
  },
